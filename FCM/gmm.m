...
% Initialise centres
%mix.centres = [0 0;4.5 3;4.5 0;1.5 3;-2 -3;-5.5 -1;-3.5 2;-2.5 4.5;2 -3.5;7 -3.5];
%mix.centres = [1 0.3 0;1 -0.3 0;-0.5 0 0.5;-0.5 -0.3 0;-0.5 0.3 0];
...
case 'spherical'
  %mix.covars = ones(1, mix.ncentres) * 0.2;
...
case 'diag'
  ...
  %mix.covars = [1 0.5;1.5 0.5;2 0.5;1 0.5;1 1.5;1 0.5;0.5 1;0.5 1;0.5 1;0.5 0.5];
